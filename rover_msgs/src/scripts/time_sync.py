...
with Bag('/home/twilight/dataset/dog_sim/old_dog_control_time_sync.bag', 'w') as Y , Bag('/home/twilight/dataset/dog_sim/old_dog_control.bag', 'r') as X :
    ...
    for topic, msg, t in X:
		...
		# print(time_for_now)
		# print(start_time)
		if topic == "/os_cloud_node3/points"  or topic == "/robot_Z/image_rect" or topic == "/os_cloud_node3/imu" :
